...
function createNote(title, text) {
  ...
  noteEl.innerHTML = `
    <div class="note-header">
      ...
      <textarea id="note-title-textarea" class="hidden">${title}</textarea>
      <div>
        <button class="note-edit"><i class="fa-solid fa-pen-to-square"></i></button>
        <button class="note-delete"><i class="fa-solid fa-eraser"></i></button>
      </div>
    </div>
  ...
  const titleInputEl = noteEl.querySelector('#note-title-textarea');
